...
export const CROP_GROW_SECONDS = { wheat: 72, olives: 105 } as const;
export const CROP_YIELD = 15;
export const FIELDS_TENDED = { farm: 12, orchard: 10 } as const;
export const FIELD_RANGE = 10;
