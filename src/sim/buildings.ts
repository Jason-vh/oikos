...
export interface BuildingDef {
  ...
  minAppeal: number;
  needsNear?: 'woods' | 'rock' | 'water';
  marbleCost?: number;
  sculptureCost?: number;
  produces: Good | null;
  consumes: Good | null;
  accepts: Good[];
  supplies: Good | null;
...
export const ELITE_TIERS: HouseTier[] = [
  ...
  },
  {
    ...
    evolveAppeal: 36,
    devolveAppeal: 25,
    needs: ['food', 'water', 'oil', 'culture', 'fleece', 'athletics', 'armour'],
  ...
  },
  {
    ...
    evolveAppeal: 50,
    devolveAppeal: 36,
    needs: ['food', 'water', 'oil', 'culture', 'fleece', 'wine', 'athletics', 'drama', 'armour'],
  ...
  },
  {
    ...
    evolveAppeal: 66,
    devolveAppeal: 50,
    needs: ['food', 'water', 'oil', 'culture', 'fleece', 'wine', 'athletics', 'drama', 'armour', 'horses'],
...
const SANCTUARY_NAMES: Record<GodKind, string> = {
  hera: 'Orchard of Hera',
  atlas: 'Pillar of Atlas',
...
export const BUILDINGS: Record<BuildingKind, BuildingDef> = {
  ...
  foundry: {
    ...
    workers: 10,
    maxWalkers: 1,
    appeal: { initial: -10, bandSize: 1, step: 1, range: 4 },
    requiresMeadow: false,
    needsRoad: true,
    requires: null,
    minAppeal: 0,
    ...
    fireRisk: 10,
    damageRisk: 5,
    description: 'Smelts copper from the rock into bronze. Must stand beside rock.',
  },
  armoury: {
    kind: 'armoury',
    name: 'Armoury',
    ...
    fireRisk: 8,
    damageRisk: 5,
    description: 'Beats bronze into armour for the mansions and the companies.',
  },
  sculptureStudio: {
    kind: 'sculptureStudio',
    ...
    fireRisk: 4,
    damageRisk: 4,
    description: 'Casts bronze into sculpture. A monument wants two of them.',
  },
  horseRanch: {
    kind: 'horseRanch',
    name: 'Horse Ranch',
    ...
    workers: 10,
    maxWalkers: 1,
    appeal: { initial: -6, bandSize: 1, step: 1, range: 4 },
    requiresMeadow: true,
    needsRoad: true,
    requires: null,
    minAppeal: 0,
    ...
    fireRisk: 4,
    damageRisk: 5,
    description: 'Grain in, horses out, on open meadow. Estates keep four.',
  },
  mint: {
    kind: 'mint',
    name: 'Mint',
    ...
    fireRisk: 4,
    damageRisk: 4,
    description: 'Strikes silver from the rock into coin, month after month.',
  },
  vineyard: {
    kind: 'vineyard',
    name: 'Vineyard',
  ...
  carrotFarm: {
    ...
    fireRisk: 2,
    damageRisk: 4,
    description: 'Carrots on the meadow, harvested in April rather than July.',
  },
  onionFarm: {
    kind: 'onionFarm',
    name: 'Onion Farm',
    ...
    fireRisk: 2,
    damageRisk: 4,
    description: 'Onions on the meadow, and another April harvest.',
  },
  huntingLodge: {
    kind: 'huntingLodge',
    name: 'Hunting Lodge',
    ...
    fireRisk: 2,
    damageRisk: 4,
    description: 'Hunters bring in meat from the woods around it.',
  },
  fishery: {
    kind: 'fishery',
    name: 'Fishery',
    ...
    fireRisk: 2,
    damageRisk: 4,
    description: 'Boats work the water beside it and land fish all year.',
  },
  granary: {
    kind: 'granary',
    name: 'Granary',
  ...
  hippodrome: {
    ...
    workers: 16,
    maxWalkers: 0,
    appeal: { initial: 12, bandSize: 2, step: -2, range: 7 },
    requiresMeadow: false,
    needsRoad: true,
    requires: 'palace',
    minAppeal: 0,
    ...
    fireRisk: 2,
    damageRisk: 3,
    description: 'Chariots race here while there are horses in its stalls, and the crowd pays to watch.',
  },
  stadium: {
    kind: 'stadium',
    name: 'Stadium',
  ...
  tradingPost: {
    ...
    produces: null,
    consumes: null,
    accepts: ['oil', 'wine', 'fleece', 'wood', 'marble', 'bronze', 'armour', 'sculpture'],
    supplies: 'food',
    capacity: 20,
    fireRisk: 4,
    damageRisk: 6,
  ...
  pyramidModest: {
    ...
    workers: 0,
    maxWalkers: 0,
    appeal: { initial: 18, bandSize: 2, step: -2, range: 7 },
    requiresMeadow: false,
    needsRoad: true,
    requires: null,
    minAppeal: 0,
    ...
    fireRisk: 0,
    damageRisk: 0,
    description: 'A small pyramid, raised course by course by artisans.',
  },
  pyramid: {
    kind: 'pyramid',
    name: 'Pyramid',
    ...
    fireRisk: 0,
    damageRisk: 0,
    description: 'A pyramid of five courses. The artisans will be years at it.',
  },
  pyramidGreat: {
    kind: 'pyramidGreat',
    name: 'Great Pyramid',
    ...
    workers: 0,
    maxWalkers: 0,
    appeal: { initial: 26, bandSize: 2, step: -2, range: 11 },
    requiresMeadow: false,
    needsRoad: true,
    requires: null,
    minAppeal: 0,
    ...
    fireRisk: 0,
    damageRisk: 0,
    description: 'The greatest thing a city can raise, and the slowest.',
  },
  artisansGuild: {
    kind: 'artisansGuild',
    name: "Artisans' Guild",
    ...
    fireRisk: 4,
    damageRisk: 4,
    description: 'Its artisans walk to whatever sanctuary is unfinished and raise it, stone by stone.',
  },
  monument: {
    kind: 'monument',
    name: 'Monument',
