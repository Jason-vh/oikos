...
export function migrateSave(parsed: RawRecord): RawRecord | null {
  ...
  if (parsed.version === 5 || parsed.version === 6) return { ...parsed, version: CURRENT_VERSION, founded: true };
  ...
  return { ...parsed, version: CURRENT_VERSION, home: islandFor(seed).home, founded: true };
}
